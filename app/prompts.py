...
keyphrases_templates = {
    'en': """
        Your task is to extract keywords from the set of arguments provided: {context}. 
    ...
    'fr': """
        ...
        Votre tâche consiste à extraire des mots-clés de cet ensemble d'arguments fournis : {context}. 
    ...
    'es': 
        """
        Su tarea consiste en extraer palabras clave del conjunto de argumentos proporcionado: {context}. 
